...
public final class Constants {
    ...
    public static final String WUM_UAT_APP_KEY = "wumUatAppKey";
    public static final String WUM_UAT_USERNAME = "wumUatUsername";
    public static final String WUM_UAT_SCOPE = "wumUatScope";
    public static final String WUM_UAT_PASSWORD = "wumUatPassword";
